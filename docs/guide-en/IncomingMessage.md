...
Attachment properties it is array of objects.
...
The attachment object has 3 basic properties. Like:
```php
...
Get the names of all attachments current message as follows:
```php
...
All information about current attachment contains info property and look like as follows:
```php
["info"]=>
    object(stdClass)#18 (2) {
      ["structure"]=>
...
Body properties contains an body attachment.
